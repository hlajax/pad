...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { description: @province.description, nom: @province.nom } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { description: @province.description, nom: @province.nom } }
